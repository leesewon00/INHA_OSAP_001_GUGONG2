...
class Set {
 ...
 public:
  ...
  bool IsEmpty() { return tree->IsEmpty(tree->getRoot()); }
  int GetSize() { return tree->GetSize(tree->getRoot()); }
  int GetHeight() { return tree->GetHeight(tree->getRoot()); }
  ...
  int Insert(T target) { return tree->Insert(target); }
